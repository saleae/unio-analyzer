...
enum UnioHeaderResult { HeaderValid, HeaderInvalid, HeaderInvalidResetPulseFound };
...
protected:  //functions
	...
	void AdvanceChannelDataEdgesToSample( U64 sample );
...
protected:  //vars
	...
	U64 mLastEndingSample;
	U64 mLastStartingSample;
